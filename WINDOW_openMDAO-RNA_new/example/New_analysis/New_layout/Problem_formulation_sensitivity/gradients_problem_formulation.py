...
P_fixedpower = np.load("power_matrix_1000MW_7D_course.dat", allow_pickle=True)
D_fixedpower  = np.load("diameter_matrix_1000MW_7D_course.dat", allow_pickle=True)
num_fixedpower = np.load("num_matrix_1000MW_7D_course.dat", allow_pickle=True)
aep_fixedpower = np.load("aep_matrix_1000MW_7D_course.dat", allow_pickle=True)
lcoe_fixedpower = np.load("lcoe_matrix_1000MW_7D_course.dat", allow_pickle=True)




aep_noloss = np.load("lossless_aep_1000MW_7D_course.dat", allow_pickle=True)
v_mean = np.load("v_mean_matrix_1000MW_7D_course.dat", allow_pickle=True)
wake_losses = np.load("wake_matrix_1000MW_7D_course.dat", allow_pickle=True)
total_turbine_costs = np.load("turbine_costs_matrix_1000MW_7D_course.dat", allow_pickle=True)
foundation_costs = np.load("foundation_costs_matrix_1000MW_7D_course.dat", allow_pickle=True)
total_oandm_costs = np.load("oandm_costs_matrix_1000MW_7D_course.dat", allow_pickle=True)
total_installation_costs = np.load("installation_costs_matrix_1000MW_7D_course.dat", allow_pickle=True)
total_electrical_costs = np.load("electrical_costs_matrix_1000MW_7D_course.dat", allow_pickle=True)
other_turbine_costs = np.load('other_turbine_costs_1000MW_7D_course.dat', allow_pickle=True)
other_farm_costs = np.load('other_farm_costs_1000MW_7D_course.dat', allow_pickle=True)
projectdev_costs = np.load('projectdev_costs_1000MW_7D_course.dat', allow_pickle=True)
decom_costs = np.load('decom_costs_1000MW_7D_course.dat', allow_pickle=True)
...
P_fixedarea = np.load("power_matrix_area150_course.dat", allow_pickle=True)
D_fixedarea  = np.load("diameter_matrix_area150_course.dat", allow_pickle=True)
num_fixedarea = np.load("num_matrix_area150_course.dat", allow_pickle=True)
aep_fixedarea = np.load("aep_matrix_area150_course.dat", allow_pickle=True)
lcoe_fixedarea = np.load("lcoe_matrix_area150_course.dat", allow_pickle=True)




aep_noloss = np.load("lossless_aep_area150_course.dat", allow_pickle=True)
v_mean = np.load("v_mean_matrix_area150_course.dat", allow_pickle=True)
wake_losses = np.load("wake_matrix_area150_course.dat", allow_pickle=True)
total_turbine_costs = np.load("turbine_costs_matrix_area150_course.dat", allow_pickle=True)
foundation_costs = np.load("foundation_costs_matrix_area150_course.dat", allow_pickle=True)
total_oandm_costs = np.load("oandm_costs_matrix_area150_course.dat", allow_pickle=True)
total_installation_costs = np.load("installation_costs_matrix_area150_course.dat", allow_pickle=True)
total_electrical_costs = np.load("electrical_costs_matrix_area150_course.dat", allow_pickle=True)
other_turbine_costs = np.load('other_turbine_costs_area150_course.dat', allow_pickle=True)
other_farm_costs = np.load('other_farm_costs_area150_course.dat', allow_pickle=True)
projectdev_costs = np.load('projectdev_costs_area150_course.dat', allow_pickle=True)
decom_costs = np.load('decom_costs_area150_course.dat', allow_pickle=True)
...
ax.text(0.2, 0.65, r'$\'{Cost}$', horizontalalignment='center',  verticalalignment='center', transform=ax.transAxes)
ax.text(0.75, 0.25, r'$\'{AEP}$', horizontalalignment='center',  verticalalignment='center', transform=ax.transAxes)
...
ax.text(0.6, 0.26, r'$\'{Cost}$', horizontalalignment='center',  verticalalignment='center', transform=ax.transAxes)
ax.text(0.3, 0.8, r'$\'{AEP}$', horizontalalignment='center',  verticalalignment='center', transform=ax.transAxes)
ax.tick_params(which='both', bottom=False, top=False, labelbottom=False, left=False, labelleft=False)
#plt.savefig('gradient_baseline_vs_fixedpower_&_fixedarea.png',bbox_inches='tight',dpi=300)
plt.show()
...
axs.quiver(D_baseline[4,4], P_baseline[4,4],  grad_electricalcosts_dia_b[4,4], grad_electricalcosts_power_b[4,4], headlength = 2, headaxislength = 2,color='C5', linestyle = '-',fc='none', ec='C5', linewidth = 1, scale = scale)
...
axs.quiver(D_baseline[4,4], P_baseline[4,4],  grad_electricalcosts_dia_fp[4,4], grad_electricalcosts_power_fp[4,4], headlength = 2, headaxislength = 2,color='C5', linestyle = '-', ec='C5', linewidth = 1, scale = scale, alpha = 0.7)
axs.quiver(D_baseline[4,4],  P_baseline[4,4], -1*grad_wake_dia_fp[4,4], -1*grad_wake_power_fp[4,4], headlength = 2, headaxislength = 2, color='C0', linestyle = '-', ec='C0', linewidth = 1, scale = scale, alpha = 0.5)
...
axs.set_title('Differing components (Fixed power)', fontsize = 16)
...
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_turbinecosts_dia_fa[2,4], grad_turbinecosts_power_fa[2,4], headlength = 2, headaxislength = 2, color='C0', linestyle = '-', ec='C0', linewidth = 1, scale = scale, alpha = 0.5)
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_other_costs_dia_fa[2,4], grad_other_costs_power_fa[2,4], headlength = 2,headaxislength = 2, color='C1', linestyle = '-', ec='C1', linewidth = 1, scale = scale, alpha = 0.5)
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_foundationcosts_dia_fa[2,4], grad_foundationcosts_power_fa[2,4], headlength = 2, headaxislength = 2,color='C2', linestyle = '-', ec='C2', linewidth = 1, scale = scale, alpha = 0.5)
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_installationcosts_dia_fa[2,4], grad_installationcosts_power_fa[2,4], headlength = 2, headaxislength = 2,color='C3', linestyle = '-', ec='C3', linewidth = 1, scale = scale, alpha = 0.5)
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_oandmcosts_dia_fa[2,4], grad_oandmcosts_power_fa[2,4], headlength = 2, color='C4', headaxislength = 2,linestyle = '-', ec='C4', linewidth = 1, scale = scale, alpha = 0.5)
axs[0].quiver(D_baseline[4,4], P_baseline[4,4],  grad_electricalcosts_dia_fa[2,4], grad_electricalcosts_power_fa[2,4], headlength = 2, headaxislength = 2,color='C5', linestyle = '-', ec='C5', linewidth = 1, scale = scale, alpha = 0.5)
...
axs[1].quiver(D_baseline[4,4],  P_baseline[4,4], -1*grad_wake_dia_fa[2,4], -1*grad_wake_power_fa[2,4], headlength = 2, headaxislength = 2, color='C0', linestyle = '-', ec='C0', linewidth = 1, scale = scale, alpha = 0.5)
axs[1].quiver(D_baseline[4,4],  P_baseline[4,4], grad_aep_noloss_dia_fa[2,4], grad_aep_noloss_power_fa[2,4], headlength = 2, headaxislength = 2, color='C1', linestyle = '-', ec='C1', linewidth = 1, scale = scale, alpha = 0.5)
#axs[1].quiver(D_baseline[4,4],  P_baseline[4,4], grad_aep_dia_b[4,4], grad_aep_power_b[4,4], headlength = 4, scale = scale, alpha = 0.5)
...
plt.savefig('gradient_components_baseline_vs_fixedarea.png',bbox_inches='tight',dpi=300)
plt.show()