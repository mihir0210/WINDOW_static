...
load('static_sp2_init.mat');

chord_profile_sp2_init = cell2mat(Chord_profile);
twist_profile_sp2_init = Twist_profile-0.35;
...
load('static_sp1_opt.mat');
chord_profile_sp1_opt = cell2mat(Chord_profile);
twist_profile_sp1_opt = Twist_profile+0.38536;
...
twist_profile_sp2_opt = Twist_profile+0.51095699;
...
%% plot comparing chord : starting point1 results for static SLSQP
...
%% plot comparing chord : starting point2 results for static SLSQP
...
%% plot comparing chord: 2 optimums for static SLSQP
...
%% plot comparing twist : starting point1 results for static SLSQP
...
%% plot comparing twist : starting point2 results for static SLSQP
...
%% plot comparing twist : 2 optimums for static SLSQP
...
load('static_sp3_init.mat');

chord_profile_sp3_init = cell2mat(Chord_profile);
twist_profile_sp3_init = Twist_profile+2.275;
...
load('static_sp3_opt.mat');

chord_profile_sp3_opt = cell2mat(Chord_profile);
twist_profile_sp3_opt = Twist_profile+ 1.919168;
