...
tower_wall_thickness_min = problem['support.tower_wall_thickness_min']
tower_wall_thickness_max = problem['support.tower_wall_thickness_max']


print_nice("LCOE", lcoe)
print_nice("AEP", aep)
print_nice("Support_base_dia",base_dia)
print_nice("Support top dia", top_dia)
print_nice("Support wall thickness minimum:", tower_wall_thickness_min)
print_nice("Support wall thickness maximum:", tower_wall_thickness_max)
