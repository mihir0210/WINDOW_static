%% Set file names9
function LinModel=Linearization(rated_windspeed,Airfoil,Blade,Control,Drivetrain,Nacelle,Tower)

%Turbine_properties=Preprocessing(2);
%load(Turbine_properties);
LinModel=[pwd,'\Linearized_model_5MW_oldmethod.mat'];
...
% Simulink settings
TSim = 52; %%%%%%%%%% Try reducing this and check gains%%%%%%%%%
