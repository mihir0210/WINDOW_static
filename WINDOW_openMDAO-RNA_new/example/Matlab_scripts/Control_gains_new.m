function [Kp,Ki]=Control_gains_new(rated_windspeed, rated_omega)
...
LinModel=Linearization_new(rated_windspeed,Airfoil,Blade,Control,Drivetrain,Nacelle,Tower);

%% Load mat file and convert data format
load(LinModel, 'Lin','data');
%data=cell2mat(data);
...
Control.Pitch.ScheduledPitchAngles=theta_new;
