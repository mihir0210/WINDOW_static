...
load('Internal_layup_dynamic_opt.mat');
...
fatigue_sf = 1; %Safety factor for fatigue. This is used to shift the
%S-N curve down
...
file = 'Fatigue_dynamic_new_U=6.00.mat'; 
