...
def load_case_selector(load_case, rotor_diameter):

    settings_run_seeds = 1.0
    settings_wind_dt = 0.1
    settings_wind_ny = 35.0
    settings_wind_nz = 35.0
    ...
    settings_wind_ly = rotor_diameter
    settings_wind_lz = rotor_diameter
    ...
    if load_case==1.3:
        ...
        settings_wind_t = 60.0
        settings_run_windspeed = 11.4
