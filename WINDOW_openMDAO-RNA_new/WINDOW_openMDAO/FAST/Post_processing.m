...
%%% Stress at Node 24 %%% 
Stress.Blade.span3_flapwise_skin =  max(abs(Spn2MLyb1))*1e3*y_flapwise_skin(24)/I_flapwise(24)/1e6;
Stress.Blade.span3_flapwise_spar =  max(abs(Spn2MLyb1))*1e3*y_flapwise_spar(24)/I_flapwise(24)/1e6;

Stress.Blade.span3_edgewise_skin =  max(abs(Spn2MLxb1))*1e3*y_edgewise_skin(24)/I_edgewise(24)/1e6;
Stress.Blade.span3_edgewise_te_reinf =  max(abs(Spn2MLxb1))*1e3*y_edgewise_te_reinf(24)/I_edgewise(24)/1e6;


%%% Stress at Node 37 %%% 
Stress.Blade.span4_flapwise_skin =  max(abs(Spn2MLyb1))*1e3*y_flapwise_skin(37)/I_flapwise(37)/1e6;
Stress.Blade.span4_flapwise_spar =  max(abs(Spn2MLyb1))*1e3*y_flapwise_spar(37)/I_flapwise(37)/1e6;

Stress.Blade.span4_edgewise_skin =  max(abs(Spn2MLxb1))*1e3*y_edgewise_skin(37)/I_edgewise(37)/1e6;
Stress.Blade.span4_edgewise_te_reinf =  max(abs(Spn2MLxb1))*1e3*y_edgewise_te_reinf(37)/I_edgewise(37)/1e6;

%%% Stress at Node 47 %%% 
Stress.Blade.span5_flapwise_skin =  max(abs(Spn2MLyb1))*1e3*y_flapwise_skin(47)/I_flapwise(47)/1e6;
Stress.Blade.span5_flapwise_spar =  max(abs(Spn2MLyb1))*1e3*y_flapwise_spar(47)/I_flapwise(47)/1e6;

Stress.Blade.span5_edgewise_skin =  max(abs(Spn2MLxb1))*1e3*y_edgewise_skin(47)/I_edgewise(47)/1e6;
Stress.Blade.span5_edgewise_te_reinf =  max(abs(Spn2MLxb1))*1e3*y_edgewise_te_reinf(47)/I_edgewise(47)/1e6;
