...
from . import aerodynamic_design, structural_design, rotor_aerodynamics, power_curve, rotor_mechanics
...
#         i.add_output('drive_train_efficiency', desc='efficiency of aerodynamic to electrical conversion')
        ...
        # sub systems
        # self.add_subsystem('aero_design', aerodynamic_design.PeggedNodes(num_pegged=num_pegged, num_nodes=num_nodes, \
        ...
        self.add_subsystem('aero_partial', rotor_aerodynamics.BEM(num_nodes=num_nodes, rho_air=rho_air), \
                           promotes_inputs=['design_tsr', 'blade_number', 'rotor_diameter', 'hub_radius', 'pitch', 'span_airfoil_id'], \
