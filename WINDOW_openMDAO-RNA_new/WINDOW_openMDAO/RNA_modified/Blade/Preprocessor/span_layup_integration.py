...
def span_layup(span_radius, span_section, web, skin, root1, root2, le_core1, spar1, te_core1, te_reinf1, le_core2, spar2,
               te_core2, te_reinf2,
    ...
    root_ = np.array([root1, root1, root2, 0, 0, 0, 0, 0, 0]).reshape(1, 9).astype(float)
    ...
    root_span = np.interp(span_section[0,:], root_section[0,:], root_[0,:])
