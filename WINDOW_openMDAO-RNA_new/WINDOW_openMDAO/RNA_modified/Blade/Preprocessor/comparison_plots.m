...
ylabel('FlapStiff ($Nm^2$)','Interpreter','latex', 'FontSize',12);
xlabel('Spanwise location','Interpreter','latex', 'FontSize',12);
grid on;
...
ylabel('EdgeStiff ($Nm^2$)','Interpreter','latex', 'FontSize',12);
xlabel('Spanwise location','Interpreter','latex', 'FontSize',12);
grid on;
legend('Analytical', '5 MW', 'SANDIA labs');
...
ylabel('BMassDens ($\frac{kg}{m}$)','Interpreter','latex', 'FontSize',12);
xlabel('Spanwise location','Interpreter','latex', 'FontSize',12);
grid on;
legend('Analytical', '5 MW', 'SANDIA labs');
