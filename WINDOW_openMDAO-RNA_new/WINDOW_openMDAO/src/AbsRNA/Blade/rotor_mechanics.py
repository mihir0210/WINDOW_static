...
class AbsRotorMechanics(ExplicitComponent):
    ...
    def setup(self):        
        ...
        #self.add_output('Root_stress', desc='Root stresses')
        self.add_output('max_stress_skin', desc='maximum stresses in the skin along the span', shape = 1)
        self.add_output('max_stress_spar', desc='maximum stresses in the spar along the span', shape=1)
