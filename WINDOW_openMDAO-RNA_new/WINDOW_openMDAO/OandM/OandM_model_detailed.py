...
def oandm_detailed(rotor_diameter, rna_costs, array_cable_costs, distance_to_harbour, n_t):
...
rotor_diameter = 240
rna_costs = 687797513/70   # RNA costs of one turbine
#ref_cable_costs = 257557706  # array + export cable cost
array_cable_costs = 97852706.1851505
distance_to_harbour= 40 #in km
n_t = 70


[costs_om, availability] = oandm_detailed(rotor_diameter, rna_costs, array_cable_costs, distance_to_harbour, n_t)
