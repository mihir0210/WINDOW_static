function [EI_flap, EI_edge, G_stiffness, EA, M_L, I_xx, y_flapwise_spar, y_flapwise_skin,...
        ...
        y_edgewise_skin] = extract_properties_parameterize(location, root, skin, le_core, spar, te_core, te_reinf, web)
...
Blade.Radius=Blade.Radius-Blade.Radius(1); %subtracting hub radius blade now goes from 0-61.5
...
max_thickness_section = max_thickness_section(1);
...
le_panel_end_=max_thickness_section-(relative_spar_cap_width)/2;
...
spar_cap_end_=max_thickness_section+(relative_spar_cap_width)/2;
...
yc_section=(E_equivalent_le_y*Area_equivalent_le*yc_le+E_equivalent_sc_y*Area_equivalent_sc*yc_sc...
    +E_equivalent_te_y*Area_equivalent_te*yc_te+E_equivalent_sw_y*Area_equivalent_sw*yc_sw+E_equivalent_te_reinf_y*Area_equivalent_te_reinf*yc_te_reinf)/...
    (E_equivalent_le_x*Area_equivalent_le+E_equivalent_sc_x*Area_equivalent_sc...
...
%%% at TE reinforcement at sections 0, 0.15, 0.3, 0.5, 0.75 and 0.95 
...
y_edgewise_te_reinf = max(element_x_upper_te);
y_edgewise_skin = max(element_x_upper_te) + (t_eq_te_panel/2)-(t_triax_skin/2);

else

y_edgewise_te_reinf = max(element_x_upper_te_reinf);
y_edgewise_skin = max(element_x_upper_te_reinf) + (t_eq_te_reinf/2)-(t_triax_skin/2);

end
% element_x_upper_le_skin = element_x_upper_le + (t_eq_le_panel/2)-(t_triax_skin/2);
% element_x_upper_sc_skin = element_x_upper_sc + (t_eq_sc/2)-(t_triax_skin/2);
% element_x_upper_te_skin = element_x_upper_te + (t_eq_te_panel/2)-(t_triax_skin/2);
% element_x_upper_te_reinf_skin = element_x_upper_te_reinf + (t_eq_te_reinf/2)-(t_triax_skin/2);
% 
% element_y_upper_le_skin = element_y_upper_le + (t_eq_le_panel/2)-(t_triax_skin/2);
% element_y_upper_sc_skin = element_y_upper_sc + (t_eq_sc/2)-(t_triax_skin/2);
% element_y_upper_te_skin = element_y_upper_te + (t_eq_te_panel/2)-(t_triax_skin/2);
% element_y_upper_te_reinf_skin = element_y_upper_te_reinf + (t_eq_te_reinf/2)-(t_triax_skin/2);
% 
% 
% x_element = [element_x_upper_le element_x_upper_sc element_x_upper_te element_x_upper_te_reinf];
% y_element = [element_y_upper_le element_y_upper_sc element_y_upper_te element_y_upper_te_reinf];
